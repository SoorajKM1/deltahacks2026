...
export default function Page() {
  ...
  return (
    <NeuroVaultShell status={status}>
      ...
      {/* LAYOUT CONTAINER 
        - h-[85vh]: Fixed height so it fits on screen without scrolling the body.
      ...
      */}
      ...
      >
        ...
        {/* --- MAIN CARD --- 
            - h-full: Fills the 85vh container exactly.
        */}
        <div className="w-[45rem] h-full shrink-0 bg-white rounded-[3rem] shadow-xl border border-slate-100 overflow-hidden flex flex-col transition-all duration-500 z-20 relative">
          ...
          {/* Display Area 
             ...
             - overflow-y-auto: Allows text to scroll while buttons stay put.
             - min-h-0: Essential for flex scrolling to work.
          */}
          ...
          {/* Control Dock 
             ...
             - py-4: Reduced padding to save space.
          */}
        ...
        {/* --- CAMERA CARD --- 
            - h-full: Matches the container height exactly.
        */}
        <div className={`
